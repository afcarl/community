...
At this time, the code in this cjoakim/community repository is a subset
of the actual private repository for the "official" version of qiflib.
The private repo contains additional data files, and rspec tests.
